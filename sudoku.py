...
class Pila:
    ...
    def sacar(self):
        ...
        return self.elementos.pop(),self.colores.pop()
...
"""
    ...
    def iniciar_juego():
        ...
        return
    def deshacer_jugada():
        global jugadas_viejas,tablero
        tablero=jugadas_viejas.pop()
        draw(grid,invertir())
        return
